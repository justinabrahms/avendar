...
HEADER_DATA *new_header	    args((void));
void	free_header	    args((HEADER_DATA *header));
...
CHAIN_DATA	*new_chain 	args( (void) );
void		free_chain 	args( (CHAIN_DATA *chain) );
...
RUMORS	*new_rumor args( (void) );
void	free_rumor args( (RUMORS *rumor) );
void rumor_maint();
